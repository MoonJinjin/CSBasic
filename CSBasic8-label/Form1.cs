...
namespace CSBasic8_label
{
    public partial class Form1 : Form
    {
        public Form1()
        {
            ...
            {
                Text = "작물", Location = new Point(250, 10), Size = new Size(100, 100)
            };
            ...
            {
                Text = "옥수수", Location = new Point(10, 70)
            };
            gp1.Controls.Add(radioButton1); gp1.Controls.Add(radioButton2); gp1.Controls.Add(radioButton3);
            Controls.Add(gp1);

            GroupBox gp2 = new GroupBox()
            {
                Text = "물고기", Location = new Point(370, 10), Size = new Size(100, 100)
            };
            RadioButton radioButton4 = new RadioButton()
            {
                Text = "광어", Location = new Point(10, 10)
            };
            RadioButton radioButton5 = new RadioButton()
            {
                Text = "연어", Location = new Point(10, 40)
            };
            RadioButton radioButton6 = new RadioButton()
            {
                Text = "참치", Location = new Point(10, 70)
            };
            gp2.Controls.Add(radioButton4); gp2.Controls.Add(radioButton5); gp2.Controls.Add(radioButton6);
            Controls.Add(gp2);

            Button radioButton = new Button()
            {
                Text = "라디오버튼", Location = new Point(250, 120), Size = new Size(230, 20)
            };
        ...
        private void radioButtonClick(object sender, EventArgs e)
        {
            foreach(var outerItem in Controls)
            {
                ...
                {
                    GroupBox gp = outerItem as GroupBox; // (GroupBox)outerItem과 같은 의미
